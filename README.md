...
### 4. Linux System Health Monitor
* **Description**: Automated server and operating system health monitoring tool delivering real-time metrics, automated system health reports, and critical email notifications.
* **Tech Stack**: `Python`, `Bash`, `Linux OS`, `Automation`, `Email Notifications`

---

### 5. Bank & Student Management Systems
* **Description**: Robust desktop management software engineered with Object-Oriented Programming (OOP) architectures, custom database file handling for persistent storage, and graphical interfaces.
* **Tech Stack**: `Java`, `JavaFX`, `C++`, `OOP`, `File Handling`
...
* **Education**: BS Computer Science (2024 – 2028), Iqra University, Karachi, Pakistan
* **Location**: Malir, Karachi, Pakistan (Available for Remote & Onsite Opportunities)
...
* Data Engineering & Algorithm Engineering
* Data Visualization & Quantitative Analytics
...
## 📂 Additional Web Applications & Projects

* [To-Do List App](https://to-do-list-ay08g000x-arhams-projects-14cbaa64.vercel.app/) — Functional task management application.
* [Quiz App](https://quiz-app-kappa-lilac.vercel.app/) — Interactive quiz with dynamic scoring and feedback.
* [Real-Time Firebase Data Website](https://firebase-data.vercel.app/) — Real-time database synchronization via Firebase.
* [CRUD App](https://curd-app-eight.vercel.app/) — Create, Read, Update, and Delete operations demo.
* [Authentication App](https://auth-app-five-beta.vercel.app/) — User authentication and secure session access.
* [Private Aviation Website](https://zyer-website-j3ea.vercel.app/) — Responsive corporate showcase for private aviation.
* [Light & Dark Mode using CSS](https://dark-mode-liart.vercel.app/) — Theme toggling with CSS custom properties.
* [Calculator](https://calculator-2-0-ebon.vercel.app/) — Full-featured web calculator.
* [Stop Watch](https://stop-watch-flame.vercel.app/) — Precision stopwatch application.
* [Academic Marksheet in JS](https://marksheet-in-javascript.vercel.app/) — Student grade calculator and display.
* [Saylani Website Clone](https://practice-saylani-clone-website.vercel.app/) — Responsive portal clone.
* [Periodic Table](https://periodic-table-using-html.vercel.app/) — Periodic table representation in semantic HTML.
* [Console Calculator](https://mini-c-log-calculator-using-javascript.vercel.app/) — Console-based arithmetic calculator.
...
* **Portfolio**: [my-portfolio-phi-six-59.vercel.app](https://my-portfolio-phi-six-59.vercel.app/)
